...
const STEPS = [
  { title: 'Define', detail: 'Goal and success criteria' },
  { title: 'Plan work', detail: 'save steps, create tickets' },
  { title: 'Run', detail: 'Conductor works through tickets' },
  { title: 'Achieved', detail: 'when completion conditions pass' },
];
